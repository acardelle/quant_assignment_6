...
The results were surprising -- all three of our interactions resulted in significant observations (p-value < 0.05) with increased correlation values as measured by R^2. Pct_car had a strong positive effect on pct_walk's contribution to a census tract's Walkability score. Whereas both pct_public and pct_bike had strong negative effects on pct_walk's contribution to a census tract's Walkability score.
