...
interaction_model1 <- lm(avg_w_ind ~ pct_asthma + pct_mental + pct_obesity + pct_walk + pct_car + pct_public + pct_bike, centered_data)

interaction_model2 <- lm(avg_w_ind ~ pct_asthma + pct_mental + pct_obesity + pct_walk + pct_car + pct_public + pct_bike + pct_walk*pct_car, centered_data)

interaction_model3 <- lm(avg_w_ind ~ pct_asthma + pct_mental + pct_obesity + pct_walk + pct_car + pct_public + pct_bike + pct_walk*pct_public, centered_data)

interaction_model4 <- lm(avg_w_ind ~ pct_asthma + pct_mental + pct_obesity + pct_walk + pct_car + pct_public + pct_bike + pct_walk*pct_bike, centered_data)

export_summs(centered_model, interaction_model1, interaction_model2, interaction_model3, interaction_model4,
             error_format = "(p = {p.value})",
             error_pos = "same",
